...
<head>
    ...
    <link href="<{$resources_dir}>/asset/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<{$Gravatar_Email_img}>" class="user-image" alt="User Image"/>
                            <span class="hidden-xs"><{$GetUserName}></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<{$Gravatar_Email_img}>" class="img-circle" alt="User Image" />
                                <p>
                                    <{$GetEmail}>
                                    <small>加入时间：<{$RegDate}></small>
                                </p>
                            </li>
...
<{block name=menu}> <{* 作为父模板，被子模板继承的块。 *}>
